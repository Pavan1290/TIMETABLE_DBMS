...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cmbChromosome.setItemText(0, _translate("Dialog", "view 1"))
        self.cmbChromosome.setItemText(1, _translate("Dialog", "view 2"))
        self.cmbChromosome.setItemText(2, _translate("Dialog", "view 3"))
        self.cmbChromosome.setItemText(3, _translate("Dialog", "view 4"))
        self.cmbChromosome.setItemText(4, _translate("Dialog", "view 5"))
